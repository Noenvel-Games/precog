      ...
      constexpr ccp kWorkspace = "workspace=class'workspace'{\n"
        ...
        //new:{                                   |
          ...
          //Common:{                              |
            ...
            //}:                                  |
            //embed_only:{                        |
            "          embed_only=function(self,paths)\n"
          ...
          //}:                                    |
          //Apple:{                               |
          "          disablePageProtection=function(self,disable)\n"
          "            self.m_disablePageProtection=disable\n"
          "            return self\n"
          "          end,\n"
  ...
  //main:{                                        |
    ...
    int IEngine::main( const strings& args ){
      ...
      //Versioning:{                              |
        ...
        static constexpr u8 patch = 0x03; // Patch (bug fixes).
        static constexpr u8 build = 0x01; // Build (Reg bvilds).
